import{i as C,a as U,e as A,N as D,x as u,b as K,f as W,R as S,A as j,d as V,M,W as F,r as Q,h as q}from"./index-TmjHplUG.js";import{r as a,n as g,c as E,U as m}from"./if-defined-C07pG3LH.js";import"./index-CG9GnfPD.js";import{M as R}from"./index-CHZpK47G.js";import"./index-cJtG5W19.js";import{S as n}from"./index-D-fHbo0W.js";import"./index-DRpp7ITe.js";import"./index-BMbTYhsY.js";import"./index-e32Wk-p9.js";import"./index-BPgWqcuj.js";import"./index-CKHoqu_1.js";const G={numericInputKeyDown(c,t,e){const o=["Backspace","Meta","Ctrl","a","A","c","C","x","X","v","V","ArrowLeft","ArrowRight","Tab"],s=c.metaKey||c.ctrlKey,i=c.key,r=i.toLocaleLowerCase(),l=r==="a",x=r==="c",v=r==="v",N=r==="x",_=i===",",L=i===".",B=i>="0"&&i<="9";!s&&(l||x||v||N)&&c.preventDefault(),t==="0"&&!_&&!L&&i==="0"&&c.preventDefault(),t==="0"&&B&&(e(i),c.preventDefault()),(_||L)&&(t||(e("0."),c.preventDefault()),(t!=null&&t.includes(".")||t!=null&&t.includes(","))&&c.preventDefault()),!B&&!o.includes(i)&&!L&&!_&&c.preventDefault()}},H=C`
  :host {
    width: 100%;
  }
