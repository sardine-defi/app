import{i as C,a as U,e as A,N as D,x as u,b as K,f as W,R as S,A as j,d as V,M,W as F,r as Q,h as q}from"./index-DIvBNGcr.js";import{r as a,n as g,c as E,U as m}from"./if-defined-BskIxcOR.js";import"./index-GEGgXk7v.js";import{M as R}from"./index-DZerJvy8.js";import"./index-B-V97-ss.js";import{S as n}from"./index-BS_8t4RP.js";import"./index-CxYAEPS2.js";import"./index-Dm5HnyBl.js";import"./index-Bg-XdQCD.js";import"./index-CR2oy8nH.js";import"./index-dfthOyhu.js";const G={numericInputKeyDown(c,t,e){const o=["Backspace","Meta","Ctrl","a","A","c","C","x","X","v","V","ArrowLeft","ArrowRight","Tab"],s=c.metaKey||c.ctrlKey,i=c.key,r=i.toLocaleLowerCase(),l=r==="a",x=r==="c",v=r==="v",N=r==="x",_=i===",",L=i===".",B=i>="0"&&i<="9";!s&&(l||x||v||N)&&c.preventDefault(),t==="0"&&!_&&!L&&i==="0"&&c.preventDefault(),t==="0"&&B&&(e(i),c.preventDefault()),(_||L)&&(t||(e("0."),c.preventDefault()),(t!=null&&t.includes(".")||t!=null&&t.includes(","))&&c.preventDefault()),!B&&!o.includes(i)&&!L&&!_&&c.preventDefault()}},H=C`
  :host {
    width: 100%;
  }
