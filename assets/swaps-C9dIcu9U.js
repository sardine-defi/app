import{i as C,a as U,e as A,N as D,x as u,b as K,f as W,R as S,A as j,d as V,M,W as F,r as Q,h as q}from"./index-CXvceVnI.js";import{r as a,n as g,c as E,U as m}from"./if-defined-Ak7_dXbJ.js";import"./index-B17b_q7r.js";import{M as R}from"./index-b9rxp9Wx.js";import"./index-B8Yftba0.js";import{S as n}from"./index-DyiyJ0Cf.js";import"./index-BwjSP61K.js";import"./index-nt-7a1rG.js";import"./index-Bu-8jagE.js";import"./index-DIhoG6uj.js";import"./index-BAnyN_YD.js";const G={numericInputKeyDown(c,t,e){const o=["Backspace","Meta","Ctrl","a","A","c","C","x","X","v","V","ArrowLeft","ArrowRight","Tab"],s=c.metaKey||c.ctrlKey,i=c.key,r=i.toLocaleLowerCase(),l=r==="a",x=r==="c",v=r==="v",N=r==="x",_=i===",",L=i===".",B=i>="0"&&i<="9";!s&&(l||x||v||N)&&c.preventDefault(),t==="0"&&!_&&!L&&i==="0"&&c.preventDefault(),t==="0"&&B&&(e(i),c.preventDefault()),(_||L)&&(t||(e("0."),c.preventDefault()),(t!=null&&t.includes(".")||t!=null&&t.includes(","))&&c.preventDefault()),!B&&!o.includes(i)&&!L&&!_&&c.preventDefault()}},H=C`
  :host {
    width: 100%;
  }
