import{i as C,a as U,e as A,N as D,x as u,b as K,f as W,R as S,A as j,d as V,M,W as F,r as Q,h as q}from"./index-Bo2zTeKi.js";import{r as a,n as g,c as E,U as m}from"./if-defined-CsBweJR3.js";import"./index-Do7axvuF.js";import{M as R}from"./index-C9tJOn8d.js";import"./index-CKX6xs1s.js";import{S as n}from"./index-C-Pe4MSG.js";import"./index-Df3WjGKC.js";import"./index-Cgiow9ko.js";import"./index-Bl_Q9_Yz.js";import"./index-CjQilp8Q.js";import"./index-nnUIhtS6.js";const G={numericInputKeyDown(c,t,e){const o=["Backspace","Meta","Ctrl","a","A","c","C","x","X","v","V","ArrowLeft","ArrowRight","Tab"],s=c.metaKey||c.ctrlKey,i=c.key,r=i.toLocaleLowerCase(),l=r==="a",x=r==="c",v=r==="v",N=r==="x",_=i===",",L=i===".",B=i>="0"&&i<="9";!s&&(l||x||v||N)&&c.preventDefault(),t==="0"&&!_&&!L&&i==="0"&&c.preventDefault(),t==="0"&&B&&(e(i),c.preventDefault()),(_||L)&&(t||(e("0."),c.preventDefault()),(t!=null&&t.includes(".")||t!=null&&t.includes(","))&&c.preventDefault()),!B&&!o.includes(i)&&!L&&!_&&c.preventDefault()}},H=C`
  :host {
    width: 100%;
  }
