import{q as _,u as O,v as R,i as d,r as y,a as h,x as l,O as a,h as j}from"./index-DIvBNGcr.js";import{n as v,c as p,o as P,r as T}from"./if-defined-BskIxcOR.js";import{e as U,n as L}from"./index-GEGgXk7v.js";const u=_({isLegalCheckboxChecked:!1}),g={state:u,subscribe(i){return R(u,()=>i(u))},subscribeKey(i,e){return O(u,i,e)},setIsLegalCheckboxChecked(i){u.isLegalCheckboxChecked=i}},E=d`
  label {
    display: flex;
    align-items: center;
    cursor: pointer;
